...
> = ({ application, isOpen, onClose }) => {
  ...
  const fetchDocuments = async () => {
    ...
    try {
      console.log(
        "Making request to fetch documents for customer:",
        application.customer._id
      );
      const response = await axios.get(
  ...
  const getDocumentStatusBadge = (status: string) => {
    ...
    return (
      <Badge className={variants[status]}>{status.replace("-", " ")}</Badge>
    );
  };

  const approvedSteps =
    application.steps?.filter((step) => step.status === "Approved").length || 0;
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  ...
                  {application.customer?.lastName} • {application.applicationId}
                </p>
              </div>
          ...
          <div className="overflow-y-auto max-h-[calc(90vh-120px)]">
            <Tabs defaultValue="details" className="w-full">
              ...
              <TabsContent value="details" className="space-y-4">
                <Accordion
                  type="multiple"
                  defaultValue={["basic", "business", "status"]}
                  className="w-full"
                >
                  {/* Basic Information */}
                        ...
                        <CardContent className="pt-6">
                          {loading ? (
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                              ...
                              <div>
                                ...
                                <p className="font-medium">
                                  {customerDetails?.nationality || "N/A"}
                                </p>
                              </div>
                              <div>
                                <label className="text-sm font-medium text-muted-foreground">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <p className="font-medium">
                                {customerDetails?.permanentAddress || "N/A"}
                              </p>
                            </div>
                            <div>
                              <label className="text-sm font-medium text-muted-foreground">
                              ...
                              <p className="font-medium">
                                {customerDetails?.currentAddress || "N/A"}
                              </p>
                            </div>
                            <div>
                              <label className="text-sm font-medium text-muted-foreground">
                        ...
                        <CardContent className="pt-6">
                          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <div>
                              ...
                              <p className="font-medium">
                                {customerDetails?.passportNumber || "N/A"}
                              </p>
                            </div>
                            <div>
                              <label className="text-sm font-medium text-muted-foreground">
                            ...
                            <div>
                              ...
                              <p className="font-medium">
                                {customerDetails?.emiratesId || "N/A"}
                              </p>
                            </div>
                            <div>
                              <label className="text-sm font-medium text-muted-foreground">
                              ...
                              <p className="font-medium">
                                {customerDetails?.residenceVisa || "N/A"}
                              </p>
                            </div>
                          </div>
                        </CardContent>
                        ...
                        <CardContent className="pt-6">
                          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <div>
                              ...
                              >
                                {customerDetails?.companyType?.toUpperCase() ||
                                  "N/A"}
                              </Badge>
                            </div>
                            <div>
                              ...
                              <p className="font-medium">
                                {customerDetails?.businessActivity1 || "N/A"}
                              </p>
                            </div>
                            <div>
                              <label className="text-sm font-medium text-muted-foreground">
                              ...
                              <p className="font-medium">
                                {customerDetails?.officeType || "N/A"}
                              </p>
                            </div>
                            <div>
                              <label className="text-sm font-medium text-muted-foreground">
                              ...
                              <p className="font-medium">
                                {customerDetails?.jurisdiction || "N/A"}
                              </p>
                            </div>
                            <div>
                              <label className="text-sm font-medium text-muted-foreground">
                              ...
                              <p className="font-medium text-green-600">
                                {customerDetails?.quotedPrice
                                  ? `AED ${customerDetails.quotedPrice}`
                                  : "N/A"}
                              </p>
                            </div>
                            <div>
                              ...
                              <p className="font-medium">
                                {customerDetails?.numberOfInvestors || "N/A"}
                              </p>
                            </div>
                          </div>
                        </CardContent>
                        ...
                        <CardContent className="pt-6">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <p className="font-medium">
                                {customerDetails?.paymentDetails || "N/A"}
                              </p>
                            </div>
                          </div>
                        </CardContent>
                                  ...
                                  onClick={() => {
                                    ...
                                    if (doc.fileUrl) {
                                      ...
                                      toast({
                                        title: "No File URL",
                                        description:
                                          "This document doesn't have a file URL to preview.",
                                        variant: "destructive",
                                      });
                                    }
                                  }}
        ...
        <PreviewDialogContent className="max-w-3xl">
          ...
          {previewType === "image" && previewUrl && (
            <img
              ...
              className="max-h-[70vh] mx-auto rounded shadow"
            />
          )}
