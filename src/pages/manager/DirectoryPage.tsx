  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Document Directory</h1>
          <p className="text-gray-600 mt-1">Manage and view all customer documents</p>
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-600">
                      <span><strong>Customer:</strong> {doc.customerName}</span>
                      <span><strong>App ID:</strong> {doc.applicationId}</span>
