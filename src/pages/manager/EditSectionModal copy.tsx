    ...
    <div className="space-y-4">
      <div>
        ...
        <Select 
          ...
          onValueChange={(value) => setApplicationDetails(prev => ({...prev, applicationType: value}))}
        >
      ...
      <div>
        ...
        <Select 
          ...
          onValueChange={(value) => setApplicationDetails(prev => ({...prev, emirate: value}))}
        >
          <SelectTrigger className="mt-1">
            <SelectValue />
          </SelectTrigger>
      ...
      <div>
        ...
        <Select 
          ...
          onValueChange={(value) => setApplicationDetails(prev => ({...prev, legalForm: value}))}
        >
          <SelectTrigger className="mt-1">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            ...
            <SelectItem value="Representative Office">Representative Office</SelectItem>
          </SelectContent>
        </Select>
      </div>
      ...
      <div>
        ...
        <Select 
          ...
          onValueChange={(value) => setApplicationDetails(prev => ({...prev, assignedAgent: value}))}
        >
          <SelectTrigger className="mt-1">
            <SelectValue />
          </SelectTrigger>
      ...
      <div>
        ...
        <Textarea 
          ...
          onChange={(e) => setApplicationDetails(prev => ({...prev, applicationNotes: e.target.value}))}
    ...
    <div className="space-y-4">
      <div>
        ...
        <Input 
          ...
          onChange={(e) => setApplicationDetails(prev => ({...prev, customerName: e.target.value}))}
          className="mt-1"
        />
      </div>
    </div>
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-3">
        ...
        {applicationDetails.proposedCompanyNames.map((name: string, index: number) => (
          <div key={index}>
            <Label className="text-sm text-muted-foreground">
              Name {index + 1} {index === 0 && <span className="text-red-500">*</span>}
            </Label>
            <Input 
              value={name}
              onChange={(e) => {
                const updatedNames = [...applicationDetails.proposedCompanyNames];
                updatedNames[index] = e.target.value;
                setApplicationDetails(prev => ({...prev, proposedCompanyNames: updatedNames}));
              }}
              className="mt-1"
      ...
      <div>
        ...
        <Select 
          ...
          onValueChange={(value) => setApplicationDetails(prev => ({...prev, officeRequirement: value}))}
        >
          <SelectTrigger className="mt-1">
            <SelectValue />
          </SelectTrigger>
      ...
      <div>
        ...
        <Select 
          ...
          onValueChange={(value) => setApplicationDetails(prev => ({...prev, officeType: value}))}
        >
          <SelectTrigger className="mt-1">
            <SelectValue />
          </SelectTrigger>
...
export const ShareholderInfoForm: React.FC<ApplicationInfoFormProps> = ({
  ...
  const removeShareholder = (index: number) => {
    const updated = applicationDetails.shareholders.filter((_: any, i: number) => i !== index);
  ...
  return (
    <div className="space-y-4">
      ...
      {applicationDetails.shareholders.map((shareholder: any, index: number) => (
        <div key={index} className="border rounded-lg p-4 space-y-3">
          <div className="flex justify-between items-center">
            <h4 className="font-medium">Shareholder {index + 1}</h4>
            <Button size="sm" variant="ghost" onClick={() => removeShareholder(index)}>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              {[
                ...
                { key: 'controlViaAgreement', label: 'Control via Agreement' },
                { key: 'significantInfluence', label: 'Significant Influence' },
                ...
                <label key={key} className="flex items-center gap-2">
                  <input 
                    type="checkbox"
                    checked={shareholder.natureOfControl[key as keyof Omit<typeof shareholder.natureOfControl, 'other'>] as boolean}
                    onChange={(e) => {
                      const updated = [...applicationDetails.shareholders];
...
export const PaymentDetailsForm: React.FC<ApplicationInfoFormProps> = ({
  ...
  const removePaymentEntry = (index: number) => {
    const updatedEntries = applicationDetails.paymentEntries.filter((_: any, i: number) => i !== index);
    setApplicationDetails(prev => ({...prev, paymentEntries: updatedEntries}));
  };
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <div className="flex items-center gap-2 mt-1">
          ...
          <Input 
            ...
            onChange={(e) => setApplicationDetails(prev => ({...prev, totalAgreedCost: Number(e.target.value)}))}
            className="flex-1"
          />
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        {applicationDetails.paymentEntries.map((payment: any, index: number) => (
          <div key={index} className="border rounded-lg p-4 space-y-3">
            <div className="flex items-center justify-between">
              <span className="font-medium">Payment {index + 1}</span>
              <Button size="sm" variant="ghost" onClick={() => removePaymentEntry(index)}>
                <Trash2 className="h-4 w-4" />
              </Button>
            </div>
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => {
                    ...
                    setApplicationDetails(prev => ({...prev, paymentEntries: updated}));
                  }}
                >
                  <SelectTrigger className="mt-1">
                    <SelectValue />
